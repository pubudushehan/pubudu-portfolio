...
const ServicesList = () => {
  const services = [
    ...
    },
    {
      ...
      technologies: ["Python", "Java", "C++", "SQL", "RESTful APIs"],
      color: "from-neon-purple to-secondary",
      delay: 0.4,
    },
    {
      icon: <FaChalkboardTeacher />,
      title: "A-level ICT Classes",
      description:
        "Providing comprehensive ICT education and guidance for A-level students.",
      technologies: [
        "Programming",
        "Database",
        "System Analysis",
        ...
        >
          <div className="card backdrop-blur-xl overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <motion.div
                className={`w-16 h-16 rounded-lg bg-gradient-to-br ${service.color} 
                  flex items-center justify-center text-2xl mb-6 glow`}
              ...
              <div className="flex flex-wrap gap-2">
                {service.technologies.map((tech) => (
                  <motion.span
                    key={tech}
                    className={`px-3 py-1 rounded-full text-sm bg-dark-light/50 
                      border border-${
